...
The Maestro Case App for the FUSION 2026 Keynote 2 demo. This is Act III, where the warranty
...
| `/cases/:id` | Case detail, across nine tabs: overview, details, actions, stages, SLAs, documents, activity, trail, comments |
...
of it is reproducible, since the storyboard sits behind auth and the console mock is a preview
